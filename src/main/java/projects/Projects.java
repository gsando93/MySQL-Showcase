...
public class Projects {
	...
	// @formatter:off
	private List<String> operations = List.of("\n 1) Add a project.", "2) List projects", "3) Select a project.", "4) Update project details.",
			"5) Delete a project.");
	// @formatter:on
	...
	System.out.println("\nThe project with ID " + projectId + " was deleted.");
	if(Objects.isNull(curProject) && projectId == curProject.getProjectId()) {
		curProject = null;
		return;
	}
	}
